#!/usr/bin/env python3
"""PRACTICE — ZETA HYBRID with 3-min expiry."""
import sys, os, time, json, importlib

AMOUNT = 5
BASE_DIR = "/root/iqoption-bot/experiments"
RESULTS_DIR = os.path.join(BASE_DIR, "results")
LOG_FILE = os.path.join(RESULTS_DIR, "zeta3_live.log")
TRADES_FILE = os.path.join(RESULTS_DIR, "zeta3_live_trades.json")

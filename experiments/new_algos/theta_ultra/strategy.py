"""
THETA ULTRA — RSI(2) < 5 / > 95 + Strong Trend
=================================================
Ultra-selective: only the most extreme RSI readings
in the strongest trends. Target: 70%+ win rate.
"""
NAME = "theta_ultra"
...
def analyze(api, asset, candles, htf_candles=None):
    ...
    if cur_adx is None or cur_adx < 25: return None,0  # Strong trend only
    ...
    # Ultra extreme oversold + strong uptrend
    if rsi2 < 5 and trend_up and mom_up:
        return "call", 80

    # Ultra extreme overbought + strong downtrend
    if rsi2 > 95 and trend_down and mom_down:
        return "put", 80

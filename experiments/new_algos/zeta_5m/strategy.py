"""
ZETA 5M — RSI-2 on 5-Minute Candles
=====================================
Longer timeframe = less noise, more reliable extremes.
Same logic as zeta_hybrid but on 5-min candles.
"""
NAME = "zeta_5m"
...
def analyze(api, asset, candles, htf_candles=None):
    # Note: candles should be 5-min candles passed from runner
    ...
    if rsi2 < 12 and trend_up and mom_up:
        return "call", 60
    if rsi2 > 88 and trend_down and mom_down:
        return "put", 60
